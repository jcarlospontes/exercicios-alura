...
public class AbrigoServiceTest {
    ...
    public void verificaQuandoHaAbrigo() throws IOException, InterruptedException {
        ...
        when(client.fazGet(anyString())).thenReturn(response);
    ...
    public void verificaQuandoNaoHaAbrigo() throws IOException, InterruptedException {
        abrigo.setId(0L);
        String expectedMessage = "Não há abrigos cadastrados";
        ...
        String[] lines = baos.toString().split(System.lineSeparator());
        String actualSemAbrigos = lines[0];

        Assertions.assertEquals(expectedMessage, actualSemAbrigos);
    }
}
